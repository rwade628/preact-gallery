...
class Pagination extends Component {
    ...
    render() {
        ...
        /* First / Last
            <li className={`pagination-arrow arrow-left ${pager.currentPage === 1 ? 'disabled' : ''}`}>
                <a onClick={() => this.setPage(1)}>keyboard_arrow_left</a>
            </li>
        ...
        return (
            <ul className="md-ui component-pagination">
                ...
                <li className={`pagination-arrow arrow-right ${pager.currentPage === 1 ? 'disabled' : ''}`}>
                    <i class="material-icons" onClick={() => this.setPage(pager.currentPage + 1)}>keyboard_arrow_right</i>
                </li>
